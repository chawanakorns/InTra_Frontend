...
const styles = StyleSheet.create({
  container: { padding: 25, paddingTop: 50, backgroundColor: '#7E9DFF', flex: 1 },
  title: { fontSize: 32, color: '#000000', fontFamily: "outfit-bold", textAlign: "center", marginTop: 80 },
  subtitle: { fontSize: 18, color: '#000000', fontFamily: "outfit", textAlign: "center", marginTop: 10 },
  question: { fontSize: 20, color: '#000000', fontFamily: "outfit-bold", marginTop: 30 },
  card: { width: CARD_SIZE, height: 130, marginVertical: 10, borderRadius: 15, overflow: "hidden", backgroundColor: '#CCCCCC', justifyContent: 'center', alignItems: 'center' },
  ...
  label: { color: '#FFFFFF', fontFamily: "outfit-bold", fontSize: 16 },
  footer: { marginTop: 20, paddingTop: 10, marginBottom: 40},
  button: { padding: 15, borderRadius: 15, marginTop: 10, borderWidth: 1 },
  primaryButton: { borderColor: '#7E9DFF', backgroundColor: '#000000ff' },
  secondaryButton: { backgroundColor: '#FFFFFF' },
  buttonText: { fontFamily: "outfit", fontSize: 16, color: '#FFFFFF', textAlign: "center" },
});